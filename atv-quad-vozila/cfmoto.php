...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-450s/index.php"><img src="/atv-quad-vozila/cfmoto/images/1.jpg" class="img-responsive" style="width:100%" alt="Image"></a>
				</div>
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-450l/index.php"><img src="/atv-quad-vozila/cfmoto/images/2.jpg" class="img-responsive" style="width:100%" alt="Image"></a>
				</div>
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-520s/index.php"><img src="/atv-quad-vozila/cfmoto/images/3.jpg" class="img-responsive" style="width:100%" alt="Image"></a>
				</div>
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-520l/index.php"><img src="/atv-quad-vozila/cfmoto/images/4.jpg" class="img-responsive" style="width:100%" alt="Image"></a>
				</div>
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-625s-touring/index.php"><img src="/atv-quad-vozila/cfmoto/images/5.jpg" class="img-responsive" style="width:100%"
							alt="Image"></a>
				</div>
				<div class="panel-heading">CFMOTO CFORCE 625S TOURING</div>
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-625l-touring"><img src="/atv-quad-vozila/cfmoto/images/6.jpg" class="img-responsive" style="width:100%"
							alt="Image"></a>
				</div>
				<div class="panel-heading">CFMOTO CFORCE 625L TOURING</div>
		...
		<div class="col-sm-6 col-xs-12 col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-body">
					<a href="/atv-quad-vozila/cfmoto/cforce-850xc/index.php"><img src="/atv-quad-vozila/cfmoto/images/7.jpg" class="img-responsive" style="width:100%"
							alt="Image"></a>
				</div>

...
<div id="carouselExampleIndicators" class="carousel slide mb-4" data-ride="carousel" data-interval="7000">
	...
	<div class="carousel-inner">
		...
		<div class="carousel-item">
			...
			<div class="carousel-caption custom-carousel-caption">
				<!-- <h1 class="slider-heading"><strong>CFORCE 850XC</strong></h1> -->
				<a href="/atv/600ltouring/index.php"><button type="button"
						class="btn btn-lg custom-button explore d-md-table mx-auto">ISTRAŽI</button></a>
			</div>
		</div>
		<div class="carousel-item">
			...
			<div class="carousel-caption custom-carousel-caption">
				<!-- <h1 class="slider-heading"><strong>CFORCE 850XC</strong></h1> -->
				<a href="/atv/1000/index.php"><button type="button"
						class="btn btn-lg custom-button explore d-md-table mx-auto">ISTRAŽI</button></a>
			</div>
		</div>
		<div class="carousel-item">
			...
			<div class="carousel-caption custom-carousel-caption">
				<!-- <h1 class="slider-heading"><strong>CFORCE 850XC</strong></h1> -->
				<a href="/motorcycles/650nk/index.php"><button type="button"
						class="btn btn-lg custom-button explore d-md-table mx-auto">ISTRAŽI</button></a>
			</div>
		</div>
		<div class="carousel-item">
			<a href="/atv/850xc/index.php">
				<img class="d-block w-100" src="/images/bg5.jpg" alt="First slide" id="slide4">
			</a>
			<div class="carousel-caption custom-carousel-caption">
				<!-- <h1 class="slider-heading"><strong>CFORCE 850XC</strong></h1> -->
				<a href="/atv/850xc/index.php"><button type="button"
						class="btn btn-lg custom-button explore d-md-table mx-auto">ISTRAŽI</button></a>
			</div>
		</div>
		<div class="carousel-item">
			<a href="/sxs/zforce1000eps/index.php">
				<img class="d-block w-100" src="/images/bg6.png" alt="First slide" id="slide4">
			</a>
			<div class="carousel-caption custom-carousel-caption">
				<!-- <h1 class="slider-heading"><strong>CFORCE 850XC</strong></h1> -->
...
<div class="row mt-4">
	<div class="col-md-12 col-lg-6 px-0 pr-lg-3 pr-xl-3">
		<a href="/atv/1000/index.php"><img src="img1.jpg" class="bg1 img-fluid" alt="inn_logo" /></a>
	</div>
...
<div class="row mt-4">
	...
	<div class="col-md-12 col-lg-6 px-0  pl-lg-2 pl-xl-2 pt-4 pt-xl-0 pt-lg-0">
		<a href="/sxs/zforce1000eps/index.php"><img src="img4.png" class="bg1 img-fluid"
				alt="ccs_logo" /></a>
	</div>
</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
	...
	<form action="" method="post">
		...
		<div class="form-group">
			<label for="country" class="font-weight-bold control-label">Zemlja</label>

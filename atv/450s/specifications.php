      ...
      <table class="table">
        <tbody>
          <tr>
            ...
            <td>
              <p class="text-right">Single-cylinder, 4-valve, SOHC, EFI, 4- stroke, T3b</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <p class="text-right">The price shown is for the BLACK and BLUE colors. For ORANGE and HUNTING CAMO MAPLE
                the price is + 100€.</p>
            </td>
          </tr>
        </tbody>
